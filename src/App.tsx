...
import { initialData, AppData } from "./data/accountData";
...
export default function App() {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case "notifications": return <Notifications data={data} setData={setData} />;
      case "profile":       return <ProfilePage data={data} setData={setData} />;
    ...
    <>
      ...
      <div style={{ display:"flex", minHeight:"100vh", background:SCSS.bgBase }}>
        ...
        <div style={{ position:"fixed", inset:0, pointerEvents:"none", zIndex:0, overflow:"hidden" }}>
          <div style={{ position:"absolute", top:-300, left:-200, width:700, height:700,
        ...
        <aside style={{
          ...
          {/* Collapse toggle */}
          <button className="btn-ghost" onClick={() => setSidebarOpen(s => !s)}
