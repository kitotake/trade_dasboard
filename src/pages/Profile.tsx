    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 20, alignItems: "start" }}>
      <div className="card fade-up" style={{ textAlign: "center" }}>
        ...
        <button
          ...
          style={{ width: "100%" }}
          onClick={() => { setForm(data.profile || {}); setEditing(true); }}
        >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <div className="card fade-up">
          ...
          {[
            ...
            <div key={k as string} style={{
              ...
              padding: "12px 0", borderBottom: `1px solid ${SCSS.borderSub}`,
            }}>
        ...
        <div className="card fade-up fade-up-1">
          ...
          {!p.name ? (
            <EmptyState
              icon="👤"
              msg="Profil non configuré"
              sub="Cliquez sur Modifier pour renseigner vos informations"
              onCta={() => { setForm({}); setEditing(true); }}
              cta="Configurer"
            />
          ) : (
            <>
              {[
                ...
                value ? (
                  <div key={label} style={{
                    display: "flex", justifyContent: "space-between",
                    padding: "10px 0", borderBottom: `1px solid ${SCSS.borderSub}`,
                  }}>
        ...
        <Modal title="Modifier le profil" onClose={() => setEditing(false)}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            ...
            <FormField label="Horizon d'investissement">
              ...
              >
                <option value="">— Choisir —</option>
                {["Court terme (< 3 ans)", "Moyen terme (3-8 ans)", "Long terme (> 8 ans)"].map(h => (
            ...
            <FormField label="Fiscalité / Enveloppes">
              <input
                placeholder="ex : PEA, CTO, Assurance-vie"
                value={form.tax || ""}
            ...
            <FormField label="Objectif principal">
              <input
                placeholder="ex : Retraite, Immobilier…"
                value={form.mainGoal || ""}
