...
const Notifications: FC<NotificationsProps> = ({ data, setData }) => {
  ...
  const save = () => {
    ...
    setData(d => ({
      ...d,
      notifications: [
        { ...form, id: uid(), time: new Date().toLocaleString("fr-FR") },
        ...(d.notifications || []),
      ],
    }));
    setModal(false);
    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 22 }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          {notifs.length > 0 && (
            <button className="btn-ghost" onClick={() => setData(d => ({ ...d, notifications: [] }))}>
              Tout effacer
            </button>
          )}
      ...
      {notifs.length === 0 ? (
        <div className="card">
          <EmptyState
            ...
            sub="Créez des alertes personnalisées pour suivre vos investissements"
              ...
              <div key={n.id} className="notif-item">
                <div className="notif-dot" style={{ background: cfg.color }}>
                  <div style={{
                    ...
                    background: cfg.color, animation: "pulseRing 1.5s ease-out infinite",
                  }} />
                </div>
